...
![Location](https://img.shields.io/badge/Brasil-333?style=flat-square&logo=googlemaps&logoColor=white)
![English](https://img.shields.io/badge/English-C1_Advanced-4CAF50?style=flat-square)
...
Coordenador de Analytics Engineering com **12+ anos** de experiência em análise de dados, engenharia de dados e gestão de produtos. Atualmente na **Zig (Global Fintech)**, onde estruturei a equipe de analytics engineering do zero e arquitetei toda a segunda camada de dados da empresa — do pipeline à visualização.

Especialista em transformar dados em decisões estratégicas: entreguei 20 KPIs críticos (receita, take rate, TPV, MDR, custo, margem) onde nenhum existia, viabilizando decisões em nível C-level.

Atualmente cursando **Pós-Graduação em Engenharia de IA** na Impacta Tecnologia.

---

## Stack Principal

**Engenharia & Pipelines**
...
[![Recharts](https://img.shields.io/badge/Recharts-22b5bf?style=flat-square&logo=react&logoColor=white)](https://recharts.org/)
...
[![react-chartjs-2](https://img.shields.io/badge/react--chartjs--2-FF6384?style=flat-square&logo=react&logoColor=white)](https://react-chartjs-2.js.org/)
[![Plotly.js](https://img.shields.io/badge/Plotly.js-3F4F75?style=flat-square&logo=plotly&logoColor=white)](https://plotly.com/javascript/)
[![react-plotly.js](https://img.shields.io/badge/react--plotly.js-3F4F75?style=flat-square&logo=react&logoColor=white)](https://plotly.com/javascript/react/)
...
[![CatBoost](https://img.shields.io/badge/CatBoost-FFCC00?style=flat-square&logoColor=black)](https://catboost.ai/)
...
[![Snowflake ML](https://img.shields.io/badge/Snowflake_ML-29B5E8?style=flat-square&logo=snowflake&logoColor=white)](https://docs.snowflake.com/en/developer-guide/snowflake-ml/overview)
...
> Projetos pessoais e estudos das fases da minha carreira em dados — de ETL e automações a machine learning e visualização.
...
| [**ml-nps-analysis**](https://github.com/edsonirvana/ml-nps-analysis) | Pipeline de análise automática de comentários NPS com LLM. StateGraph (LangGraph) com 7 nós, roteamento dinâmico entre modelos (Claude, LLaMA, Mistral, Mixtral), classificação por categoria e tipo de sentimento, retry automático por nó. **LangGraph · Snowflake Cortex · Python** |
| [**ml-rfm-segmentation**](https://github.com/edsonirvana/ml-rfm-segmentation) | Segmentação RFM de usuários por estabelecimento com scoring quintil — duas variantes: venues físicos e ticketing. Scores calculados por venue (não globalmente), processamento em batches de 100 lugares. **Pandas · NumPy · Snowflake Feature Store** |
| [**ml-product-classification**](https://github.com/edsonirvana/ml-product-classification) | Pipeline NLP em 3 estágios para classificar nomes livres de produtos em categorias de bebidas. OneClassSVM para detecção, CatBoost para tipo e categoria, fuzzy matching de marcas via rapidfuzz. **CatBoost · TF-IDF · NLTK · rapidfuzz · MLflow** |
| [**ml-user-return-propensity**](https://github.com/edsonirvana/ml-user-return-propensity) | Predição de propensidade de retorno por par usuário-estabelecimento. Features RFM por par + perfil global do usuário, carregamento em batches de 3 meses, threshold 0.70 para alta precisão. **CatBoost · MLflow · scikit-learn** |
...
| Repositório | Descrição |
|---|---|
| [**receita-pordia-juno-compython**](https://github.com/edsonirvana/receita-pordia-juno-compython) | Análise de receita diária via API Juno (gateway de pagamentos). Usa **Pandas**, **NumPy** e **Matplotlib** para transformar e visualizar os dias de maior volume de receita no mês. |
| [**juno-api-python**](https://github.com/edsonirvana/juno-api-python) | Integração com a API da Juno em Python — autenticação, extração e tratamento de dados transacionais para pipelines analíticos. |
| [**cvs-import-to-mysql-with-python**](https://github.com/edsonirvana/cvs-import-to-mysql-with-python) | Script de importação automatizada de arquivos CSV para MySQL via Python. Útil para processos de carga inicial e migração de dados. |
...
| Repositório | Descrição |
|---|---|
| [**machine-learning-regressao-python**](https://github.com/edsonirvana/machine-learning-regressao-python) | Implementação de modelos de regressão em Python — exploração de algoritmos supervisionados para previsão de variáveis contínuas. |
...
| Repositório | Descrição |
|---|---|
| [**ETL_TCC**](https://github.com/edsonirvana/ETL_TCC) | Projeto de TCC focado em pipeline ETL completo — extração, transformação e carga de dados com documentação do processo end-to-end. |
| [**dataquality**](https://github.com/edsonirvana/dataquality) | Scripts e rotinas de Data Quality — validação, checagem de consistência e identificação de anomalias em datasets. |
| [**sql**](https://github.com/edsonirvana/sql) | Coleção de queries e patterns SQL avançados: window functions, CTEs, otimização de performance e casos de uso analíticos. |
...
| Repositório | Descrição |
|---|---|
| [**spark-3.0.1-bin-hadoop3.2**](https://github.com/edsonirvana/spark-3.0.1-bin-hadoop3.2) | Configuração e experimentos com **Apache Spark 3.0.1 + Hadoop 3.2** — setup de ambiente para processamento distribuído de dados. |
| [**unixtimestamp-to-timestamp-withScala**](https://github.com/edsonirvana/unixtimestamp-to-timestamp-withScala) | Utilitário em **Scala** para conversão de Unix Timestamps — solução prática para pipelines Spark que lidam com campos de data/hora. |
...
| Repositório | Descrição |
|---|---|
| [**dataviz**](https://github.com/edsonirvana/dataviz) | Experimentos e estudos em visualização de dados — gráficos, dashboards e boas práticas para comunicação de insights. |
...
| Repositório | Descrição |
|---|---|
| [**notes**](https://github.com/edsonirvana/notes) | Notas pessoais de aprendizado em Python, SQL e conceitos de dados — documentação contínua do processo de evolução técnica. |
...
![GitHub Stats](https://github-readme-stats.vercel.app/api?username=edsonirvana&show_icons=true&theme=dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&text_color=8b949e&icon_color=58a6ff)

![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=edsonirvana&layout=compact&theme=dark&hide_border=true&bg_color=0d1117&title_color=58a6ff&text_color=8b949e)
...
*"Dados sem contexto são ruído. Dados com governança são vantagem competitiva."*
