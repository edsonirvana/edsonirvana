...
![Location](https://img.shields.io/badge/Brazil-333?style=flat-square&logo=googlemaps&logoColor=white)
...
Analytics Engineering Coordinator with **12+ years** of experience across data analytics, data engineering, and product management. Currently at **Zig (Global Fintech)**, where I built the analytics engineering team from scratch and architected the company's entire second data layer — from pipeline to visualization.

Specialist in turning data into strategic decisions: delivered 20 critical KPIs (revenue, take rate, TPV, MDR, cost, margin) where none existed, enabling C-level decision-making.

Currently pursuing a **Postgraduate degree in AI Engineering** at Impacta Tecnologia.
...
**Programmatic Visualization (React)**
...
> Personal projects and studies from different phases of my data career — from ETL and automation to machine learning and visualization.
...
|---|---|
| [**fintech-data-mock**](https://github.com/edsonirvana/fintech-data-mock) | Full data pipeline for a fictional fintech (**PayBridge Financeira**) on GCP. PostgreSQL legacy ingestion via Python ETL → Cloud Storage → BigQuery, **dbt** transformations with Medallion Architecture (staging → intermediate → marts), semantic layer in **LookML/Looker**, and governance with RLS, PII masking, and financial reconciliation tests. KPIs: TPV, MDR, NPL, credit exposure, chargeback rate, and net revenue. |
| [**ml-churn-classifier**](https://github.com/edsonirvana/ml-churn-classifier) | Binary churn classification pipeline for transactional businesses — built and validated at production scale. 80+ behavioral and financial features engineered from transaction history, with no dependency on CRM or demographic data. **CatBoost · SMOTE · MLflow · scikit-learn** |
...
| Repository | Description |
|---|---|
| [**receita-pordia-juno-compython**](https://github.com/edsonirvana/receita-pordia-juno-compython) | Daily revenue analysis via Juno API (payment gateway). Uses **Pandas**, **NumPy**, and **Matplotlib** to transform and visualize peak revenue days of the month. |
| [**juno-api-python**](https://github.com/edsonirvana/juno-api-python) | Python integration with the Juno API — authentication, extraction, and transactional data handling for analytical pipelines. |
| [**cvs-import-to-mysql-with-python**](https://github.com/edsonirvana/cvs-import-to-mysql-with-python) | Automated CSV import script to MySQL via Python. Useful for initial load processes and data migration. |
...
| Repository | Description |
|---|---|
| [**machine-learning-regressao-python**](https://github.com/edsonirvana/machine-learning-regressao-python) | Regression model implementations in Python — exploration of supervised learning algorithms for continuous variable prediction. |
...
| Repository | Description |
|---|---|
| [**ETL_TCC**](https://github.com/edsonirvana/ETL_TCC) | Academic project focused on a complete ETL pipeline — extraction, transformation, and loading with end-to-end process documentation. |
| [**dataquality**](https://github.com/edsonirvana/dataquality) | Data Quality scripts and routines — validation, consistency checks, and anomaly detection in datasets. |
| [**sql**](https://github.com/edsonirvana/sql) | Collection of advanced SQL queries and patterns: window functions, CTEs, performance optimization, and analytical use cases. |
...
| Repository | Description |
|---|---|
| [**spark-3.0.1-bin-hadoop3.2**](https://github.com/edsonirvana/spark-3.0.1-bin-hadoop3.2) | Setup and experiments with **Apache Spark 3.0.1 + Hadoop 3.2** — environment configuration for distributed data processing. |
| [**unixtimestamp-to-timestamp-withScala**](https://github.com/edsonirvana/unixtimestamp-to-timestamp-withScala) | **Scala** utility for Unix Timestamp conversion — practical solution for Spark pipelines handling date/time fields. |
...
| Repository | Description |
|---|---|
| [**dataviz**](https://github.com/edsonirvana/dataviz) | Data visualization experiments and studies — charts, dashboards, and best practices for communicating insights. |
...
| Repository | Description |
|---|---|
| [**notes**](https://github.com/edsonirvana/notes) | Personal learning notes on Python, SQL, and data concepts — ongoing documentation of my technical growth journey. |
...
*"Data without context is noise. Data with governance is competitive advantage."*
